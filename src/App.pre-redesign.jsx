...
function Hero() {
  return (
    ...
    >
      {/* Animated color-shift wash */}
      <div className="absolute inset-0 hero-gradient-overlay pointer-events-none" />

      {/* Ambient spotlight beams */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute hero-spotlight" style={{ width: "55vw", height: "55vw", top: "-15%", left: "-15%" }} />
        <div className="absolute hero-spotlight" style={{ width: "40vw", height: "40vw", top: "10%", right: "-10%", animationDelay: "-6s" }} />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pb-24 w-full">
        <div className="max-w-3xl">
          <h1
            ...
            style={{ fontFamily: HEADING, fontSize: "clamp(2.6rem,6vw,5rem)", fontWeight: 800, letterSpacing: "-0.02em", textShadow: "0 4px 24px rgba(0,0,0,0.7), 0 1px 3px rgba(0,0,0,0.9)" }}
          >
          ...
          <p
            ...
            style={{ color: BRAND, letterSpacing: "0.2em", fontFamily: MONO, textShadow: "0 2px 12px rgba(0,0,0,0.85)" }}
          >
            Critical Power. Engineered to Specification.
          </p>

          <p
            className="readable-text mb-10 max-w-xl"
            style={{ color: "#C8C8C8" }}
          >
            We engineer, source, and deliver the power generation, distribution, connectivity, and cooling infrastructure that modern B2B facilities run on. Direct pricing. Global reach. Our spec.
          </p>

          <div className="flex flex-wrap items-center gap-4">
            <a
              href="#rfq"
              className="group inline-flex items-center gap-3 px-8 py-4 font-bold text-sm uppercase transition-all duration-200"
              style={{
                background: BRAND,
                color: "#fff",
...
const KEY_STATS = [
  { end: 44, suffix: "", label: "Product Lines" },
  { end: 4, suffix: "", label: "Divisions" },
  { end: 50, suffix: "+", label: "Countries Supplied" },
...
function StatsBar() {
  return (
    <div
      ...
      style={{ position: "relative", zIndex: 2, background: "linear-gradient(rgba(10,10,10,0.85), rgba(10,10,10,0.85)), url('/scene1-aerial.jpg')", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat", borderTop: "1px solid rgba(232,99,26,0.18)", borderBottom: "1px solid rgba(232,99,26,0.18)" }}
    >
      <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8">
        {KEY_STATS.map((s, i) => (
          <FadeIn key={s.label} delay={i * 0.1} className="text-center">
            <div className="font-black mb-1" style={{ fontFamily: HEADING, fontSize: "clamp(2rem,4vw,2.75rem)", color: "#fff" }}>
              <Counter end={s.end} suffix={s.suffix} />
            </div>
            <div className="text-xs font-semibold uppercase" style={{ fontFamily: MONO, color: "#E8631A", letterSpacing: "0.16em" }}>
              {s.label}
            </div>
          </FadeIn>
        ))}
  ...
  return (
    ...
    >
      ...
      <div className="p-4 flex flex-col flex-1">
        ...
        <p className="product-card-spec readable-text mb-4 flex-1" style={{ color: "#C8C8C8" }}>{product.spec}</p>
        <a
          href="#rfq"
